 ...
 */
export async function generateRetailInvoiceAccBillPdf(invoiceData: PdfInvoiceData): Promise<Uint8Array> {
...
function drawInvoiceInfoSection(
    ...
    const details = [
        ...
        { label: 'Due Date', value: invoiceData?.dueDate ? formatDate(invoiceData.dueDate) : null},
