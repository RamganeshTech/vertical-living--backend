...
import PublicQuoteCostCalculatorModel from '../../../../models/marketing_models/lead_model/publicCostCalculator_model/publicCostCalculator.model';
...
export const createPublicQuote = async (req: Request, res: Response):Promise<any> => {
    try {
        const { name, phone, location, carpetArea, homeType, 
            finish, estimate , config, quotationPdf, consent, source,
        detailedAddress,
bestTimeFrom,
bestTimeTo
        } = req.body;
