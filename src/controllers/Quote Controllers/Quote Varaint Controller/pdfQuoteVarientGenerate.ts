...
export const generateQuoteVariantPdf = async ({
    ...
    try {
        ...
        // FIRST VERSION FO TABLE WITH BORDERS
        ...
        //             // Item Name column (left aligned) - center vertically for multi-line text
        //             const itemName = row.itemName || "-";
        //             const itemNameLines = drawLeftAlignedText(itemName, xPos, columnWidths[columnIndex], rowYPosition - 5, normalFont, FONT_SIZE);
        //             xPos += columnWidths[columnIndex++];

        //             // Quantity column (centered) - center vertically
        //             const quantityText = String(row.plywoodNos?.quantity || 0);
        //             const centerY = rowYPosition - rowHeight / 2 - 3;
        ...
        //             const description = row.description || "-";
        //             const descriptionLines = drawLeftAlignedText(description, xPos, columnWidths[columnIndex], rowYPosition - 5, normalFont, FONT_SIZE);
        //             xPos += columnWidths[columnIndex++];
