        ...
        try {
            ...
            if (logo) {
                ...
                if (logoImage) {
                    ...
                    const { width: originalWidth, height: originalHeight } = logoImage;
            ...
            const totalWidth = (logoDims?.width || 0) + spacing + brandTextWidth;
            ...
            const textY = logoImage
                ? topY - (logoDims.height / 2) - (brandFontSize / 3)
                : topY - brandFontSize;
            ...
            yPosition = logoImage
                ? topY - logoDims.height - 5
                : topY - brandFontSize - 10;
