...
const InstantCostCalculatorMainSchema = new Schema<IInstantCostMain>(
    {
        ...
        }, // Extracted from Category fields
...
// InstantCostProductSchema.index({ organizationId: 1 });

export const InstantCostCalculatorMainModel = mongoose.model<IInstantCostMain>(
    "InstantCostCalculatorMainModel",
    InstantCostCalculatorMainSchema
);