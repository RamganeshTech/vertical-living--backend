...
resetRouter.put('/stage7/paymentconfirmation/:projectId', multiRoleAuthMiddleware("owner", "CTO", "staff"), checkPreviousStageCompleted(TechnicalConsultationModel),  resetStage7)
