...
import { createOrganziation, deleteOrganization, getMyOrganizations, getOrganizationById, getStaffsByOrganization, inviteStaff, removeStaffFromOrganization, updateOrganizationName } from '../../controllers/organization controllers/organiziation.controllers';
...
orgsRouter.put('/updateorganization/:orgId',userAuthenticatedMiddleware, updateOrganizationName as RequestHandler)
