...
import { addResponse, createIssue, deleteConversation, getProjectDiscussions } from '../../../controllers/stage controllers/Issue Discussion Controllers/issueDiscussion.controller';
...
issueDiscussionRoutes.post("/createissue",multiRoleAuthMiddleware("owner", "staff", "CTO", "worker"),   createIssue); // field name used in FormData
