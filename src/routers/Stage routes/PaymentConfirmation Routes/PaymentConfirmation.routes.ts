...
// MD approval status
paymentConsentRoutes.put("/mdapprovalstatus/:projectId",multiRoleAuthMiddleware("owner"), checkPreviousStageCompleted(CostEstimationModel),notToUpdateIfStageCompleted(PaymentConfirmationModel), updateMdApprovalStatus);
// MD notes
paymentConsentRoutes.put("/mdnotes/:projectId",multiRoleAuthMiddleware( "owner"),checkPreviousStageCompleted(CostEstimationModel), notToUpdateIfStageCompleted(PaymentConfirmationModel),updateMdNotes);


//  STEP 3

paymentConsentRoutes.post("/createorder/:projectId", multiRoleAuthMiddleware("client"), checkPreviousStageCompleted(CostEstimationModel), notToUpdateIfStageCompleted(PaymentConfirmationModel), createPaymentConfirmationOrder);
paymentConsentRoutes.post("/verifypayment/:projectId", multiRoleAuthMiddleware("client"), checkPreviousStageCompleted(CostEstimationModel), notToUpdateIfStageCompleted(PaymentConfirmationModel), verifyPaymentConfirmation);
