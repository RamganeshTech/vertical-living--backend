...
import {
    ...
    updateMaterialAndLabourCategoryDescriptions,
...
MateroialWithLabourRateConfigRoutes.put("/categories/:categoryId/description", multiRoleAuthMiddleware("owner", "CTO", "staff"), updateMaterialAndLabourCategoryDescriptions);
