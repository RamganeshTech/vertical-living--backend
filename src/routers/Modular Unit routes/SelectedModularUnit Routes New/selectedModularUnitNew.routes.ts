...
import { addSelectedUnitNew, deleteSelectedUnitNew, generateModularUnitsPDFController, getSelectedUnitsByProjectNew } from "../../../controllers/Modular Units Controllers/SelectedModularUnitsNew  Controllers/selectedModularUnitNew.controller";
...
SelectedModularUnitNewRoutes.post("/:projectId/pdfgenerate",multiRoleAuthMiddleware("owner", "CTO", "staff"),generateModularUnitsPDFController);
